...
void Connection::addOnConnect(function<void(const int &id)> clbk)
{
    onConnect = clbk;
}
void Connection::addOnDisconnect(function<void(const int &id, const int &)> clbk)
{
    onDisconnect = clbk;
}
...
void Connection::addOnMessage(function<void(const int &id, const GenericMessage &msg)> clbk)
{
    onMessage = clbk;
}

void Connection::addOnPublish(function<void(const int &id, const string &topic)> clbk)
{
    onPublish = clbk;
}

void Connection::addOnSubscribe(function<void(const int &id, const string &topic)> clbk)
{
    onSubscribe = clbk;
}

void Connection::addOnUnsubscribe(function<void(const int &id, const string &topic)> clbk)
{
    onUnsubscribe = clbk;
}